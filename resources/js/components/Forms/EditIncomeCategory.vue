<template>
    <div class="row">
        <div class="col-md-12 col-lg-10 offset-lg-1">
            <h1 class="bb">
                Edit Income Category <i>({{ category ? category.name : ''}})</i>

                <button class="btn btn-primary right" @click="showIncomeCategoriesTable"><i class="fa fa-chevron-left"></i> Income Categories</button>
            </h1>
    ...
    methods: {
        ...
        updateIncome() {
            ...
            window.Alert.confirm("Are you sure you want to edit this income category?", function() {
                ...
                window.axios.patch( window.makeUrl( "/user/income_categories/" + that.category.id ), { name, description } ).then(resp => {
