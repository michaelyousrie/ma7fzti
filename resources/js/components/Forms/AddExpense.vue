        ...
        <div class="col-md-12 col-lg-10 offset-lg-1">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-12">
                    ...
                    <button class="btn btn-success btn-block" @click="addExpense">Add Expense</button>
                </div>
                <!-- /Buttons -->
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        addExpense() {
            ...
            window.Alert.confirm("Are you sure you want to add this Expense?", function() {
                ...
                window.axios.post( window.makeUrl( "/expenses" ), { description, category_id, amount } ).then(resp => {
                    that.$emit('updateUser');
                    that.clearForm();
                    that.showExpensesTable();
                    window.Alert.msg("Expense Added!");
                }).catch(error => {
